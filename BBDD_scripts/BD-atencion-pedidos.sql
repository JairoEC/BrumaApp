CREATE DATABASE IF NOT EXISTS bd_ms_atencion_pedidos;
use bd_ms_atencion_pedidos;
...
('Miguel', 'Torres', 'Vargas', '73456890', 'miguel.torres@bruma.pe', 'Chef', '2023-05-10', 1),
...
('Té Matcha Latte', 'Bebidas Calientes', 'Té verde matcha orgánico con leche de almendras', 12.00, 30, 1),
...
-- Postres
('Porción Torta de Chocolate', 'Postres', 'Bizcocho húmedo de cacao con fudge artesanal', 12.00, 20, 1),
('Cheesecake de Maracuyá', 'Postres', 'Tarta de queso con base de galleta y jalea de maracuyá', 14.00, 15, 1),
...
('Sándwich Mixto', 'Snacks', 'Pan de molde con jamón glaseado y queso edam derretido', 8.00, 30, 1),
